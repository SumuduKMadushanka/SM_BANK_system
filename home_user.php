        ...
        <div class="web_body clearfix">
            ...
            <table class="balance_table">
                <tr>
                    ...
                    <td class="balance_table_data"> <?php echo "Rs. " . number_format($current_balance, 2, '.', ''); ?> </td> <!-- balance_table_data -->
                </tr>

                <tr>
                    <td class="balance_table_label"> Current Loan Amount </td> <!-- balance_table_label -->
                    <td class="balance_table_data"> <?php echo "Rs. " . number_format($current_loan, 2, '.', ''); ?> </td> <!-- balance_table_data -->
                </tr>
            </table> <!-- balance_table -->
        </div> <!-- web_body -->
    </main> <!-- main_body -->
